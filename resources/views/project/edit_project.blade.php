        ...
        <div class="card">
            <form action="{{ route('project.update', $project->id ) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="form-group has-danger row">
                            <label class="control-label text-end col-md-2">تعداد</label>
                            <div class="col-md-8">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="form-group has-danger row">
                            <label class="control-label text-end col-md-2">انتخاب واحد*</label>
                            <div class="col-md-9">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="form-group has-danger row">
                            <label class="control-label text-end col-md-2">تطبیق کننده*</label>
                            <div class="col-md-8">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="form-group has-danger row">
                            <label class="control-label text-end col-md-2">دیزاین کننده*</label>
                            <div class="col-md-8">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="form-group has-danger row">
                            <label class="control-label text-end col-md-2">موقعیت(ناحیه)*</label>
                            <div class="col-md-9">
